...
public:
	...
	void render(const RID p_source, const Size2i p_source_size, const RID p_target, const Size2i p_target_size) { filter_chain->render(p_source, p_source_size, p_target, p_target_size); }
